...
python n_t_ratios_facets.py -f input_files/exons_combined -D -u -a $A -g $G -p '"Mouse", "Human"' -o figure8.pdf
...
python n_t_ratios_facets.py -f input_files/exons_combined -D -u -a $A -p '"Mouse", "Human"' -o online_figure8.pdf -G $G
